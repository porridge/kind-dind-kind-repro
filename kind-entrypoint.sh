...
fix_cgroup() {
  ...
  echo before:
  head -n 99999 /proc/self/mountinfo /proc/self/cgroup | tee /tmp/mountinfo-and-cgroup
  ...
  echo after:
  head -n 99999 /proc/self/mountinfo /proc/self/cgroup | diff -u /tmp/mountinfo-and-cgroup - || true
  find /sys/fs/cgroup || true
}
